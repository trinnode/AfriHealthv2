            ...
            <div className="bg-afrihealth-gray-900 border-2 border-afrihealth-teal/30 rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden">
              ...
              <div className="relative bg-gradient-to-r from-afrihealth-teal/10 to-afrihealth-orange/10 p-6 border-b border-afrihealth-gray-700">
                ...
                <p className="text-afrihealth-gray-300 font-mono text-sm">
                  Choose your role to connect your wallet
                </p>
              </div>
              ...
              <div className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <motion.button
                    ...
                    disabled={isConnecting}
                    className="group relative bg-gradient-to-br from-afrihealth-green/10 to-afrihealth-green/5 border-2 border-afrihealth-green hover:border-afrihealth-green/80 rounded-xl p-8 text-left transition-all disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-afrihealth-gray-300 font-mono text-sm mb-4">
                        Access your medical records, manage appointments, and
                  ...
                  <motion.button
                    ...
                    disabled={isConnecting}
                    className="group relative bg-gradient-to-br from-afrihealth-orange/10 to-afrihealth-orange/5 border-2 border-afrihealth-orange hover:border-afrihealth-orange/80 rounded-xl p-8 text-left transition-all disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
                  >
                    {/* Glow effect on hover */}
                    ...
                    <div className="relative">
                      ...
                      <p className="text-afrihealth-gray-300 font-mono text-sm mb-4">
                        Manage patient records, submit claims, and provide
                        quality care
                      </p>
                      <ul className="space-y-2 text-sm text-afrihealth-gray-400 font-mono">
                        <li className="flex items-center gap-2">
                ...
                <div className="mt-8 p-4 bg-afrihealth-gray-800/50 rounded-lg border border-afrihealth-gray-700">
                  <p className="text-xs text-afrihealth-gray-400 text-center font-mono">
                    🔒 Your wallet will be used to securely access the platform.{" "}
                    <br />
                    Make sure you have HashPack installed for the best
                    experience.
                  </p>
                </div>
              </div>
