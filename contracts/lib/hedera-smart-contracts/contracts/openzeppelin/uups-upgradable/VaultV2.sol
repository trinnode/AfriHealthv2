...
//: As the state variables are shared and store in a proxy contract's storage, working with low-level assembly code
//          to access directly to the storage is recommended.
//: Avoid working with state variables among implementation contracts
...
contract VaultV2 is VaultV1 {
  ...
  function initializeV2(address beneficiary) external reinitializer(2) {
  ...
  function version()
    ...
    virtual
    override
    returns (uint256 currentVersion)
  {
    assembly {
