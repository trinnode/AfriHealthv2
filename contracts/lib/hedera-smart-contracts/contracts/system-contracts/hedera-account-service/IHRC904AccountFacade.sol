...
interface IHRC904AccountFacade {
  /// Enables or disables automatic token associations for the calling account
  /// Responsible service: HAS
  ...
  function setUnlimitedAutomaticAssociations(
    bool enableAutoAssociations
