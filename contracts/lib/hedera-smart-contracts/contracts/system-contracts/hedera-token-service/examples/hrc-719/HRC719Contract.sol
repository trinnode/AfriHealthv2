...
contract HRC719Contract {
  ...
  /// @param token The address of the token to associate with.
  /// Making isAssociated(address) non-view function to avoid going through mirror-node as isAssociated() is not yet fully supported on mirror node.
  /// Should be transitioned to view function when the feature is supported by mirror node. Tracking by this issue https://github.com/hashgraph/hedera-smart-contracts/issues/948
