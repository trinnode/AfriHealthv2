...
interface IHederaTokenService {
  ...
  /// Immediate airdrops are irreversible, pending airdrops can be canceled
  ...
  /// Rejects one or more tokens by transferring their full balance from the requesting account to the treasury
  /// This transfer does not charge any custom fees or royalties defined for the tokens
  /// For fungible tokens, the requesting account's balance will become 0 and the treasury balance will increase by that amount
  /// For non-fungible tokens, the requesting account will no longer hold the rejected serial numbers and they will be transferred to the treasury
