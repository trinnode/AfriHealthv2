...
contract DeployHederaTestnet is Script {
    ...
    function deployContracts(DeploymentConfig memory config) internal {
        ...
        deployed.consentFacet = address(new ConsentFacetHCS());
        console.log("  ConsentFacet:", deployed.consentFacet);

        deployed.tokenFacet = address(new TokenFacetHTS());
    ...
    function initializeDiamond(DeploymentConfig memory config) internal {
        ...
        accessControlSelectors[3] = AccessControlFacet.getRoleAdmin.selector;
        ...
        consentSelectors[0] = ConsentFacetHCS.grantConsent.selector;
        consentSelectors[1] = ConsentFacetHCS.revokeConsent.selector;
        consentSelectors[2] = ConsentFacetHCS.getConsent.selector;
        consentSelectors[3] = ConsentFacetHCS.hasValidConsent.selector;
        ...
        tokenSelectors[0] = TokenFacetHTS.createPlatformCreditToken.selector;
        tokenSelectors[1] = TokenFacetHTS.mintTokensHTS.selector;
        tokenSelectors[2] = TokenFacetHTS.transferTokensHTS.selector;
